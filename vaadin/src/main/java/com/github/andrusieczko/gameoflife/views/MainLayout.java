package com.github.andrusieczko.gameoflife.views;
...
import com.github.andrusieczko.gameoflife.views.helloworld.HelloWorldView;
import com.github.andrusieczko.gameoflife.views.about.AboutView;
 ...
 */
@PWA(name = "Game of Life: Vaadin", shortName = "Game of Life: Vaadin", enableInstallPrompt = false)
@Theme(themeFolder = "gameoflifevaadin")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Game of Life: Vaadin logo"));
        logoLayout.add(new H1("Game of Life: Vaadin"));
